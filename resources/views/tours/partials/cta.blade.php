<section class="py-14 bg-gradient-to-br from-ink via-slate-800 to-brand-700" aria-label="Book tour CTA">
    <div class="max-w-3xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:{{ config('site.phone') }}" class="border-2 border-white/40 text-white font-semibold text-sm px-10 py-4 rounded-full hover:bg-white/10 transition-colors">
